...
const SlideTraction = () => (
  <div className="absolute inset-0 w-screen h-screen flex items-center justify-center overflow-hidden bg-background">
    ...
    {/* Content */}
    <motion.div
      className="relative z-10 w-full max-w-6xl px-8 md:px-12"
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
        ...
        <motion.div variants={fadeIn} className="flex flex-col gap-5">
          <div className="mb-2">
            ...
            <h3 className="text-xl font-bold text-foreground">Start here</h3>
          </div>

          <div className="rounded-xl border border-border/60 bg-card/40 p-5 backdrop-blur-sm">
            <div className="flex items-baseline gap-2 mb-2">
              <span className="text-lg font-bold text-foreground">Reset</span>
              <span className="text-lg font-bold text-primary">£24.95</span>
            </div>
          ...
          <div className="rounded-xl border border-border/60 bg-card/40 p-5 backdrop-blur-sm">
            <div className="flex items-baseline gap-2 mb-2">
              ...
              <span className="text-lg font-bold text-stark-periwinkle">Free</span>
            </div>
            <p className="text-sm text-muted-foreground leading-relaxed">
              Journeys (Basic)<br />
              → one guided route<br />
        ...
        {/* Flow connector left→middle (visible md+) */}

        {/* COLUMN 2 — CORE */}
        <motion.div variants={fadeIn} className="flex flex-col gap-5 relative">
          {/* Subtle left arrow */}
          ...
          <div className="mb-2">
            ...
            <h3 className="text-xl font-bold text-foreground">Make it personal</h3>
          </div>

          <div className="rounded-xl border border-primary/30 bg-card/50 p-5 backdrop-blur-sm ring-1 ring-primary/10">
            <div className="flex items-baseline gap-2 mb-2">
              <span className="text-lg font-bold text-foreground">Journeys+</span>
              <span className="text-lg font-bold text-primary">£12/month</span>
            </div>
            <p className="text-sm text-muted-foreground leading-relaxed">
        ...
        <motion.div variants={fadeIn} className="flex flex-col gap-5 relative">
          ...
          <div className="mb-2">
            ...
            <h3 className="text-xl font-bold text-foreground">Go further</h3>
          </div>

          <div className="rounded-xl border border-border/60 bg-card/40 p-5 backdrop-blur-sm">
            <div className="flex items-baseline gap-2 mb-2">
              <span className="text-lg font-bold text-foreground">Challenges</span>
              <span className="text-lg font-bold text-primary">£19 / £29 / £49</span>
            </div>
            <p className="text-sm text-muted-foreground leading-relaxed mb-3">
              → choose your destination<br />
              → complete the journey
            </p>
            <div className="flex flex-col gap-1 text-xs text-stark-periwinkle/80">
          ...
          <div className="rounded-xl border border-border/60 bg-card/40 p-5 backdrop-blur-sm">
            <p className="text-sm font-semibold text-foreground/80 mb-2">Make it real</p>
