...
const PhaseTitle = () => (
  <div className="absolute inset-0">
    ...
    />
    <div
     className="relative z-10 flex flex-col items-center md:items-end h-full pt-16 md:pt-24 px-6 justify-start"tems-center justify-center h-full px-6 md:px-8"
      style={{
        textShadow:
