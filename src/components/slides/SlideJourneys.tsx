...
const PhaseMap = () => (
  <div className="absolute inset-0">
    ...
    />
    <div className="absolute z-10 top-[18vh] left-1/2 -translate-x-1/2 w-full max-w-[720px] px-6 md:top-[28vh] md:left-auto md:right-[20%] md:translate-x-0 md:max-w-[460px] md:px-0">
