...
const PhaseTitle = () => (
  <div className="absolute inset-0">
    ...
    <div
      ...
      style={{
        textShadow: "0 2px 14px hsl(var(--background) / 0.8), 0 1px 5px hsl(var(--background) / 0.6)",
      }}
    >
...
const PhaseMap = () => (
  <div className="absolute inset-0">
    ...
    />
    <div className="absolute z-10 top-[22vh] left-1/2 -translate-x-1/2 w-full max-w-[720px] px-6 md:top-[24vh] md:left-[10%] md:right-auto md:translate-x-0 md:max-w-[480px] md:px-0">
      <div className="text-center md:text-left">
        <h2 className="text-2xl md:text-3xl lg:text-[2.7rem] font-bold text-foreground leading-[1.02] mb-7 md:mb-8">
          ...
          <p className="text-base md:text-lg mt-4">
            <span
              ...
              style={{
                ...
                textShadow: "0 0 12px hsl(var(--stark-sunset) / 0.6), 0 0 28px hsl(var(--stark-sunset) / 0.3)",
              }}
            >
  ...
  <div className="absolute inset-0">
    ...
    <div className="relative z-10 flex items-center h-full px-6 md:px-0" style={{ paddingLeft: "max(1.5rem, 8%)" }}>
      <div
        className="max-w-2xl"
        style={{
          textShadow: "0 2px 10px hsl(var(--background) / 0.6), 0 1px 4px hsl(var(--background) / 0.4)",
        }}
      >
        ...
        <div className="mt-4 md:mt-6">
          <p
            ...
            style={{
              ...
              textShadow: "0 0 18px hsl(var(--stark-sunset) / 0.8), 0 0 40px hsl(var(--stark-sunset) / 0.45)",
            }}
          >
