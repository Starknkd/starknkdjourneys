...
const PhaseMap = () => (
  <div className="absolute inset-0">
    ...
    />
    <div className="absolute z-10 top-[28vh] left-1/2 -translate-x-1/2 w-full max-w-[720px] px-6 md:top-[24vh] md:left-[10%] md:right-auto md:translate-x-0 md:max-w-[480px] md:px-0">
